...
SELECT C.ID_PREREQ,C.NOME AS 'NOME DO CURSO',C.VALOR AS 'PREÇO' ,C.HORAS 'TOTAL DE HORAS',
IFNULL(CP.NOME,'---') AS REQUISITO_MINIMO
FROM CURSOS  C
INNER JOIN CURSOS CP  
ON C.IDCURSO = CP.ID_PREREQ;
